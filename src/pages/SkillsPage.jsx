...
const SkillPage = () => {
  const skills = [
    { name: 'HTML', value: 95, color: null },
    { name: 'CSS', value: 85, color: 'warning' },
    { name: 'PHP', value: 90, color: 'danger' },
    { name: 'Javascript', value: 90, color: 'danger' },
    { name: 'Angular JS', value: 95, color: 'dark' },
    { name: 'Wordpress', value: 85, color: 'info' },
  ];

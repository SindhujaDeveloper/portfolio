...
;
const metadata = {
    title: 'Portfolio Revamp | Sindhuja',
    description: 'A modernized portfolio for Sindhuja, a passionate developer, showcasing skills and projects. Built with Next.js, TypeScript, and enhanced with AI features.',
    keywords: [
        'React Developer',
        'TypeScript',
        'Next.js',
